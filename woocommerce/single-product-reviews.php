...
<div id="reviews" class="woocommerce-Reviews">
	<img src="<?php echo get_template_directory_uri(); ?>/images/cooking-bg-bottom-lef.png" class="cooking-bg-bottom-left">
	<img src="<?php echo get_template_directory_uri(); ?>/images/cooking-bg-bottom-right.png" class="cooking-bg-bottom-right">
	<div id="comments">
	...
	<?php if ( get_option( 'woocommerce_review_rating_verification_required' ) === 'no' || wc_customer_bought_product( '', get_current_user_id(), $product->get_id() ) ) : ?>
		...
		<div id="review_form_wrapper">
			...
			<div class="comment-lists-container">
				<?php if ( have_comments() ) : ?>
				<h4>
					<i><img src="<?php echo get_template_directory_uri(); ?>/images/icons/comment-icon.png"></i>
